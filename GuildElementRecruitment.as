...
package 
{
    ...
    public dynamic class GuildElementRecruitment extends MovieClip 
    {
        ...
        public function GuildElementRecruitment(ID:int, _arg_2:String, Name:String, Level:int):void
        {
            this.ID = ID;
            this.Date = _arg_2;
            this.Name = Name;
