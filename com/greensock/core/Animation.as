...
package com.greensock.core
{
    ...
    public class Animation 
    {
        ...
        public function eventCallback(_arg_1:String, callback:Function=null, params:Array=null):*
        {
            if (_arg_1 == null)
            {
                return (null);
            ...
            if (_arg_1.substr(0, 2) == "on")
            {
                ...
                {
                    this.vars[_arg_1] = callback;
                    this.vars[(_arg_1 + "Params")] = (((params is Array) && (!(params.join("").indexOf("{self}") === -1))) ? this._swapSelfInParams(params) : params);
                };
                if (_arg_1 == "onUpdate")
                {
        ...
        public function totalTime(time:Number=NaN, suppressEvents:Boolean=false, uncapped:Boolean=false):*
        {
            ...
            if (this._timeline)
            {
                ...
                if (this._timeline.smoothChildTiming)
                {
                    ...
                    tl = this._timeline;
                    this._startTime = (((this._paused) ? this._pauseTime : tl._time) - (((this._reversed) ? (this._totalDuration - time) : time) / this._timeScale));
        ...
        public function timeScale(value:Number=NaN):*
        {
            ...
            {
                t = (((this._pauseTime) || (this._pauseTime == 0)) ? this._pauseTime : this._timeline._totalTime);
        ...
        public function paused(value:Boolean=false):*
        {
            ...
            if (value != this._paused)
            {
                if (this._timeline)
                {
                    ...
                    {
                        this._startTime = (this._startTime + elapsed);
                        this._uncache(false);
                    };
